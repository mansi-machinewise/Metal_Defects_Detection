...
class DefectModelTrainer:
    ...
    def _build_training_params(self) -> dict:
        ...
        params: dict = {
            ...
            "box":          self.train_cfg.get("box", 7.5),
            "cls":          self.train_cfg.get("cls", 2.0),
            "dfl":          self.train_cfg.get("dfl", 1.5),
            "cos_lr":       self.train_cfg.get("cos_lr", True),
            "single_cls":   self.train_cfg.get("single_cls", False),
            # Augmentation
            "hsv_h":        aug.get("hsv_h", 0.01),
